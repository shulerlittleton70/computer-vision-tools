...
MAX_DISTANCE = 250
SMOOTHING_WINDOW = 5
VOLUME_TOLERANCE = 1  # Only set volume if it changes significantly

# Volume control via osascript (macOS)
...
last_set_volume = -1  # Initialize outside valid range
...
while True:
    ...
    is_muted = False
    volume_percent = last_set_volume  # default to last
    ...
    if len(lmList) != 0:
        ...
        if length <= MUTE_THRESHOLD:
            ...
            # Avoid unnecessary AppleScript calls
        ...
        # Draw volume control line and circles
